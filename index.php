...
?>< !DOCTYPE html>
  ...
  <head>
    ...
    <meta name="description"
      content="Portfolio webového vývojáře Vitalii Stetsenko: front-end, React, JavaScript, PHP, moderní projekty, zkušenosti a kontaktní formulář. Kreativní vývojář s 9+ lety zkušeností.">
    <meta name="keywords"
      content="frontend developer, web developer, portfolio, React, JavaScript, PHP, HTML, CSS, vývoj webu, České Budějovice, Vitalii Stetsenko">
    ...
    <meta property="og:description"
      content="Front-end vývojář s 9+ lety zkušeností. Moderní webové projekty, technologie, zkušenosti a kontaktní formulář.">
    ...
    <meta name="twitter:description"
      content="Front-end vývojář s 9+ lety praxe. Prohlédněte si moje projekty a technologický stack.">
...
?>
    < !-- <link rel="stylesheet" href="assets/css/styles.css" media="print" onload="this.media='all'">-->< !--
        ...
        < !-- </noscript>-->< !-- <link rel="preload" href="assets/css/styles.css" as="style">
...
?>
    ...
    <?include_once 'templates/_Aside.php';
?>
  </body>
